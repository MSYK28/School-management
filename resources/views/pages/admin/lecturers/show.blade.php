    ...
    <div class="col-md-12 ">
        <div class="card">
            <div class="card-header">
                ...
                <a href="/lecturers" class="btn btn-sm btn-danger float-right">Back</a>
                <p class="card-category">Expanded information about {{ $lecturers->name }}</p>
                <hr>
            </div>
            <div class="card-body">
                <div class="row">
            ...
            <div class="card-body">
                <div class="card-header">
                    <h4 class="card-title">Enrolled lecturers</h4>
