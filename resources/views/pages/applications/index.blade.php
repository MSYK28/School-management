            ...
            <div class="card striped-tabled-with-hover">
                <div class="card-header ">
                    <a href="{{ URL::to('applications') }}">
                        <h4 class="card-title">School Student Applications</h4>
                    </a>
                ...
                <div class="card-body table-full-width table-responsive">
                    <table class="table table-hover table-striped">
                        ...
                        <tbody>
                            ...
                            <td>
                                <a href="{{ url('applications/' . $application->id) }}" class="btn btn-sm btn-info">Info</a>
                                    <a href="{{ url('applications/' . $application->id . '/edit') }}" class="btn btn-sm btn-success">Admit</a>
